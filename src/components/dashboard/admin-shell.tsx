...
export function AdminShell({ children }: { children: ReactNode }) {
  return (
    <div
      ...
      className="min-h-screen bg-[radial-gradient(circle_at_top_left,_rgba(56,189,248,0.15),_transparent_30%),linear-gradient(180deg,#f8fafc_0%,#edf3f8_100%)] text-slate-950"
    >
